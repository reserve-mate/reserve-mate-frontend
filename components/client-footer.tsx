              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <ul className="space-y-2">
                    <li>
                      <Link href="/facilities" className="text-sm text-gray-600 hover:text-indigo-600">
                        시설 찾기
                      </Link>
                    </li>
                    <li>
                ...
                <div>
                  <h3 className="text-sm font-bold uppercase tracking-wider text-indigo-800 mb-3">고객센터</h3>
                  <ul className="space-y-2">
                    <li>
                    ...
                    <li>
                      <span className="text-sm text-gray-600">고객센터: 1234-5678</span>
                    </li>
                  </ul>
                </div>
              </div>
      ...
      <div className="hidden lg:block py-8">
        <div className="container max-w-6xl mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="space-y-3">
              <h3 className="text-sm font-bold uppercase tracking-wider text-indigo-800">서비스</h3>
              <ul className="space-y-2">
                <li>
                  <Link href="/facilities" className="text-sm text-gray-600 hover:text-indigo-600">
                    시설 찾기
            ...
            <div className="space-y-3">
              <h3 className="text-sm font-bold uppercase tracking-wider text-indigo-800">회사</h3>
              <ul className="space-y-2">
                <li>
                  <Link href="/about" className="text-sm text-gray-600 hover:text-indigo-600">
                    회사 소개
            ...
            <div className="space-y-3">
              <h3 className="text-sm font-bold uppercase tracking-wider text-indigo-800">고객센터</h3>
              <ul className="space-y-2">
                <li>
                  <Link href="/faq" className="text-sm text-gray-600 hover:text-indigo-600">
                    자주 묻는 질문
