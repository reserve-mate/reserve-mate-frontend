                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <CardTitle className="text-lg">
                          {payment.matchName || payment.facilityName || "예약 결제"}
                        </CardTitle>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="space-y-1 text-sm">
                  <div className="flex justify-between">
                    <span>상품명:</span>
                    <span>{selectedPayment.matchName || selectedPayment.facilityName}</span>
                  </div>
                  <div className="flex justify-between">
                    <span>결제금액:</span>
            ...
            <div className="grid gap-6 py-4">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div className="space-y-3">
                    <div>
                      ...
                      <p className="font-medium">{selectedPayment.matchName || selectedPayment.facilityName}</p>
                    </div>
                    <div>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg space-y-2 text-sm">
                  ...
                  {selectedPayment.facilityName && (
                    <div className="flex justify-between">
                      <span>시설명:</span>
                      <span>{selectedPayment.facilityName}</span>
                    </div>
                  )}
                </div>
              </div>
